function Export-IOPI_ExcelXlsx {
  <#
    .SYNOPSIS
    ...
    (This script will by referenced with the name: Export-)
    
    .DESCRIPTION
    (This script will by referenced with the name: Export-ISB_ExcelXlsx)
    ...
    .EXAMPLE
    PS C:\> Get-ChildItem $env:windir | Select-Object Mode,LastWriteTime,Length,Name  | Export-ISB_ExcelXlsx -Path 'D:\temp\PSExcel.xlsx' -WorkSheetName 'Files'
    ...
    .EXAMPLE
    PS C:\> Get-Process | Select-Object Handles,Id,ProcessName | Export-ISB_ExcelXlsx -Path 'D:\temp\PSExcel.xlsx' -WorkSheetName 'Processes' -Append
    ...
    (This script is referenced with the name: Export-ISB_ExcelXlsx)
