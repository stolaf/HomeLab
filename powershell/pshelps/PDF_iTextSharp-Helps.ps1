...
Add-Type -Path "C:\Users\Olaf\Downloads\itextsharp-all-5.5.10\itextsharp-dll-core\itextsharp.dll"
#$reader = New-Object iTextSharp.text.pdf.pdfreader -ArgumentList $(Join-Path "$($pwd)" "JSPopupCalendar.pdf")
$reader = New-Object iTextSharp.text.pdf.pdfreader -ArgumentList "C:\Users\Olaf\Downloads\Readme.pdf"
$reader.Info
$reader.JavaScript
...
$reader = New-Object iTextSharp.text.pdf.pdfreader -ArgumentList $(Join-Path "$($pwd)" "Readme.pdf")
...
$source = $(Join-Path "$($pwd)" "MeinNeuesPDF.pdf")
$destination = $(Join-Path "$($pwd)" "FranzKopie.pdf")
$watermarklocation = $(Join-Path "$($pwd)" "MultiplePivotTables.png")
